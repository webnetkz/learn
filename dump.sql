...
--
-- Host: localhost    Database: learn_sql
-- ------------------------------------------------------
...
INSERT INTO `create_sql` VALUES (1,'Создание нового пользователя и установкой пароля','CREATE USER \'<span class=\"c\">nameNewUser</span>\'@\'<span class=\"c\">localhost\'</span> IDENTIFIED BY \'<span class=\"c\">passwordNewUser</span>\';'),(2,'Создание новой базы данных и установка кодировок','CREATE DATABASE <span class=\"c\">nameDatabase</span> CHARACTER SET <span class=\"c\">utf8</span> COLLATE <span class=\"c\">utf8_general_ci</span>;'),(3,'Создать таблицу с первичным ключем','CREATE TABLE <span class=\"c\">nameNewTable</span>(<br>-><span class=\"c\">id</span> INT UNSIGNED NOT NULL AUTO_INCREMENT,<br>-><span class=\"c\">name</span> CHAR(255) NOT NULL,<br>-><span class=\"c\">pass</span> VARCHAR(8000) NOT NULL,<br>->PRIMARY KEY (<span class=\"c\">id</span>)<br>->);'),(4,'none','False'),(5,'none','none'),(6,'mmmmыафыаыфвафы','mmmm12312ываыва'),(7,'1231221321312','22222'),(8,'mmmmm','232');
...
-- Dump completed on 2019-02-12  4:10:51
